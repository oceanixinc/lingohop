...
const ExperiencePanel = () => (
  ...
  <div style={{textAlign: 'center', marginTop: 0}}>
    <Paper style={style} zDepth={1} >
      ...
      <div style={nameStyle}>
      <span style={firstNameStyle}>Alex </span><span> : Study Aboard</span>
         </div>
    ...
    <Paper style={style} zDepth={1} >
      <img src='static/photos/person2.png' style={imageStyle} />
       <div style={nameStyle}>
      <span style={firstNameStyle}>Sarah </span><span> : Vacation</span>
         </div>
           <CardTitle style={cardStyle}
      titleStyle = {mediaTitleStyles.title}
      subtitleStyle={mediaTitleStyles.subtitle} 
    ...
    <Paper style={style} zDepth={1} >
      <img src='static/photos/person3.png' style={imageStyle} />
       <div style={nameStyle}>
      <span style={firstNameStyle}>Marc </span><span> : business trip</span>
         </div>
           <CardTitle style={cardStyle}
      titleStyle = {mediaTitleStyles.title}
      subtitleStyle={mediaTitleStyles.subtitle} 
