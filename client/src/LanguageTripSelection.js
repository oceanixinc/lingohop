...
export default class SelectLangaugeCountry extends React.Component {
    ...
    _createTripMenuItems() {
        ...
        for (let province of provinces) {
            ...
            let item = (<MenuItem value={itemIndex} key={`key-${province}`} primaryText={province}/>);
            menuItems.push(item);
        }
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                for (let trip of res) {
                    ...
                    let item = (<MenuItem value={trip.id} key={key} primaryText={trip.name}/>);
    ...
    render() {
        return (
            <div style={{
                ...
                <TextField value={this.state.email} style={{
                    width: 320,
                    verticalAlign: 'bottom'
                }} onChange={e => this.setState({email: e.target.value})} floatingLabelText="Email" errorText={this.state.email_error_text} onBlur={this.isDisabled}/>
                <div style={{
                    display: 'inline'
                }}>
                ...
                <div style={{
                    ...
                    <IconButton iconStyle={{
                        ...
                        <ArrowIcon color={Colors.cyan500} style={{
                            marginTop: 30
